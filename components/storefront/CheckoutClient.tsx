              ...
              <div className="bg-white rounded-2xl border border-gray-100 p-5 sm:p-6 space-y-3 shadow-sm">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
                  ...
                  <button 
                    ...
                    className="flex items-center justify-center gap-2.5 w-full border border-gray-200 rounded-full py-3 px-4 text-xs font-bold text-gray-700 hover:border-[#FF7A00] hover:text-[#FF7A00] transition-colors bg-white shadow-xs cursor-pointer disabled:opacity-60"
                  >
                    {googleLoading ? (
                      <>
